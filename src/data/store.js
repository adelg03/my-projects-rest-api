...
let projects = [
  ...
  },
  {
    id: 2,
    name: 'Voting Website',
    description: 'Learn what you need to know to start voting',
    created_at: seededAt,
    updated_at: seededAt,
  },
]
...
let tasks = [
  {
    ...
    description: 'Make a high-fidelity prototype for the website',
    status: 'done',
    created_at: seededAt,
    updated_at: seededAt,
  },
  {
    ...
    project_id: 2,
    title: 'Links Page',
    description: 'add links to links page and design buttons.',
    status: 'todo',
    created_at: seededAt,
    updated_at: seededAt,
  },
  {
    ...
    project_id: 1,
    title: 'Deploy',
    description: 'Test that it works and deploy the website',
    status: 'done',
    created_at: seededAt,
    updated_at: seededAt,
  },
